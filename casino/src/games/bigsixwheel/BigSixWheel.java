...
public class BigSixWheel extends Game {
    ...
    private static class Bet {
        ...
        private final Symbol on; //what is 'on', a symbol? what symbol? the symbol bet on right now?
     ...
     * @return rouletteBets they player wants to make
     */
    private Bet takeBet() {
