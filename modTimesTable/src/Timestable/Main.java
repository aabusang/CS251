...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        /**
         * Questions.
         * Do I need to add a scene for all the buttons I add?
         * Is the run and pause button different from the start and stop buttons above
         * Where can I find the action to start and stop the program or do I need to write a method for it?
         */
        ...
        runButton.setOnAction(e ->{ timer.start();});
        pauseButton.setOnAction(e ->{timer.stop();});

        //I am not sure if these two lines below needs to be there, just testing
        //runButton.getOnMouseClicked();
        //pauseButton.getOnMouseClicked();
