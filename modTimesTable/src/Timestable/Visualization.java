...
import Timestable.PointOnCircle;
...
public class Visualization {
    ...
    public Group generateLines(double numPoints) {
        ...
        // fill this in by instantiating a new Color
        ...
        for (PointOnCircle poc : points) {
            ...
            double correspondingPointId = (getTimesTableNum() * poc.getId() ) % numPoints; // TODO: replace 0 with the correct equation
            ...
            Line line = new Line(pointFrom.getX(), pointFrom.getY(), pointTo.getX(), pointTo.getY()); // TODO: fill this constructor in
